                            ...
                            <div class="input-group mb-3">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.create')): ?>
                                    <div class="input-group-prepend">
                                        <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> NUEVO</a>
                                    </div>
                                <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th scope="row" style="text-align: center"><?php echo e(++$no + ($users->currentPage()-1) * $users->perPage()); ?></th>
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "<?php echo e(route("users.index")); ?>/"+id,
                        data:   {
                            "id": id,
                            "_token": token
                        },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\helpdesk-main\resources\views/users/index.blade.php ENDPATH**/ ?>